...
// class ServiceConference extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       body: Center(child: Text('VideoCall')),
//     );
//   }
// }
...
void main() => runApp(const ServiceConference());

class ServiceConference extends StatelessWidget {
  const ServiceConference({Key? key}) : super(key: key);
